...
variable "cloud_run_service_name" {
  description = "Name of the Cloud Run service for anthrokrishi-api"
  type        = string
  default     = "anthrokrishi-api"
}

variable "cloud_run_location" {
  description = "Location of Cloud Run for anthrokrishi-api service"
  type        = string
  default     = "asia-south1"
}

variable "cloud_run_min_instance_count" {
  description = "Minimum number of instance of anthrokrishi-api service"
  type        = number
  default     = 1
}

variable "cloud_run_max_instance_count" {
  description = "Maximum number of instance of anthrokrishi-api service"
  type        = number
  default     = 20
}
