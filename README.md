...
Please refer to the [Customer Onboarding](./Anthrokrishi_API_Customer_Onboarding.pdf) documentation for instructions on using this repository.
...
- `Anthrokrishi_API_Customer_Onboarding`: contains instructions for deploying the service.
